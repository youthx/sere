...
typedef enum Sere_MouseButtons {
    SERE_MOUSE_BUTTON_LEFT,
    SERE_MOUSE_BUTTON_RIGHT,
    SERE_MOUSE_BUTTON_MIDDLE,
    SERE_MAX_MOUSE_BUTTONS,
} Sere_MouseButtons;

#define DEFINE_KEY(name, code) SERE_KEY_##name = code

typedef enum Sere_Keys {
...
SERE void Sere_InitInput();

SERE b8 Sere_InputInitialized();

SERE void Sere_ShutdownInput();

void Sere_InputUpdate();

SERE b8 Sere_InputIsKeyDown(Sere_Keys key);
SERE b8 Sere_InputIsKeyUp(Sere_Keys key);
SERE b8 Sere_InputWasKeyDown(Sere_Keys key);
SERE b8 Sere_InputWasKeyUp(Sere_Keys key);
...
SERE b8 Sere_InputIsMouseButtonDown(Sere_MouseButtons button);
SERE b8 Sere_InputIsMouseButtonUp(Sere_MouseButtons button);
SERE b8 Sere_InputWasMouseButtonDown(Sere_MouseButtons button);
SERE b8 Sere_InputWasMouseButtonUp(Sere_MouseButtons button);

SERE void Sere_InputGetMousePosition(i32* x, i32* y);
SERE void Sere_InputGetPreviousMousePosition(i32* x, i32* y);
